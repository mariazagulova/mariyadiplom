...
# + + +
connect(pptg[pptg_GABA], snc[snc_GABA], weight_coef=0.05)
connect(pptg[pptg_ACh], snc[snc_GABA], syn_type=ACh, weight_coef=0.05)
connect(pptg[pptg_Glu], snc[snc_DA], syn_type=Glu, weight_coef=0.05)
