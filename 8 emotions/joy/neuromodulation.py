...
connect(striatum[D1], snr[snr_GABA], weight_coef=0.001)
connect(striatum[D1], gpi[gpi_GABA], weight_coef=0.001)
#connect(striatum[D1], gpe[gpe_GABA], weight_coef=0.05)
...
connect(stn[stn_Glu], gpe[gpe_GABA], syn_type=Glu, weight_coef=0.00003)
...
if dopamine_flag and serotonin_flag and noradrenaline_flag:
    ...
    connect(lc[lc_N0], rostral_group[rostral_group_A1], syn_type=NA_ex, weight_coef=0.005)
    connect(lc[lc_N1], rostral_group[rostral_group_A2], syn_type=NA_ex, weight_coef=0.005)
    connect(rostral_group[rostral_group_A1], dr[dr_5HT], syn_type=NA_ex, weight_coef=0.005)
    connect(rostral_group[rostral_group_A2], dr[dr_5HT], syn_type=NA_ex, weight_coef=0.005)
    connect(rostral_group[rostral_group_A1], mnr[mnr_5HT], syn_type=NA_ex, weight_coef=0.005)
