...
add_connection(bnst[bnst_GABA], pvn[paraventicular_nucleus], syn_type=GABA, weight_coef=0.005)
...
add_connection(pvn[paraventicular_nucleus], motor[motor_Glu0] syn_type=GABA, weight_coef=0.005)
add_connection(pvn[paraventicular_nucleus], motor[motor_Glu1] syn_type=GABA, weight_coef=0.005)
...
add_connection(striatum[striatum_GABA], lc[lc_GABA], syn_type=GABA, weight_coef=0.005)
add_connection(vta[vta_D0], lc[lc_D1], syn_type=DA_ex, weight_coef=0.005)
add_connection(vta[vta_D0], prefrontal[prefrontal_Glu], syn_type=DA_ex, weight_coef=0.005)
...
if noradrenaline_flag:
    ...
    add_connection(lc[lc_N0], motor[motor_Glu], syn_type=NA_ex, weight_coef=0.005)
    add_connection(lc[lc_N0], prefrontal[pf_Glu], syn_type=NA_ex, weight_coef=0.005)
    ...
    add_connection(lc[lc_N1], striarum[tan], syn_type=NA_ex, weight_coef=0.005)
    ...
    add_connection(vta[vta_a1], vta[vta_D1], syn_type=NA_in, weight_coef=0.005)
...
add_connection(amygdala[amygdala_Glu], gpe[gpe_GABA], syn_type=Glu, weight_coef=0.3, syn_type=Glu)
add_connection(gpe[gpe_GABA], amygdala[amygdala_Glu], syn_type=GABA, weight_coef=0.1, syn_type=Glu)
...
add_connection(thalamus[thalamus_Glu], motor_d[motor_d_Glu1], syn_type=Glu)
...
add_connection(vta[vta_GABA0], prefrontal[pfc_Glu1],syn_type=GABA,)
add_connection(vta[vta_GABA0], pptg[pptg_GABA],syn_type=GABA,)
add_connection(vta[vta_GABA1], vta[vta_DA0],syn_type=GABA,)
add_connection(vta[vta_GABA1], vta[vta_DA1],syn_type=GABA,)
