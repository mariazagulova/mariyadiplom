...
add_connection(prh[perirhinal_cortex], lc[locus_coeruleus], syn_type=GABA)
...
add_connection(motor[motor_d_Glu0], striatum[D1], syn_type=Glu, weight_coef=0.005)
add_connection(motor[motor_d_Glu0], snc[snc_DA], syn_type=Glu, weight_coef=0.000005)
add_connection(motor[motor_d_Glu0], striatum[D2], syn_type=Glu, weight_coef=0.05)
add_connection(motor[motor_d_Glu0], thalamus[thalamus_Glu], syn_type=Glu, weight_coef=0.008)
add_connection(motor[motor_d_Glu0], stn[stn_Glu], syn_type=Glu, weight_coef=7)
...
if generator_flag:
    ...
    connect_generator(lc[locus_coeruleus], 100., 500., rate=250, coef_part=1)
    connect_generator(nts[nts_a1], 100., 500., rate=250, coef_part=1)
    connect_generator(nts[nts_a2], 100., 500., rate=250, coef_part=1)
#########dopa########
