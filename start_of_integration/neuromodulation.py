...
##########################################################
connect_generator(nts[nts_a1], 500., 600., rate=100, coef_part=1)
connect_generator(nts[nts_a2], 500., 600., rate=100, coef_part=1)
connect_generator(prh[prh_GABA], 500., 600., rate=100, coef_part=1)
connect_generator(pgi[pgi_GABA], 500., 600., rate=100, coef_part=1)
connect_generator(pgi[pgi_Glu], 500., 600., rate=100, coef_part=1)
connect_generator(ldt[ldt_a1], 500., 600., rate=100, coef_part=1)
connect_generator(ldt[ldt_a2], 500., 600., rate=100, coef_part=1)
connect_generator(ldt[ldt_Ach], 500., 600., rate=100, coef_part=1)
connect_generator(lc[lc_N0], 500., 600., rate=100, coef_part=1)
connect_generator(lc[lc_N1], 500., 600., rate=100, coef_part=1)
###########################################################
